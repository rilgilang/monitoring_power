  ...
  datasets: [
    {
      ...
      data: [
        200, 190, 180, 175, 170, 165, 160, 155, 150, 155, 160, 165, 
    ...
    },
    {
      label: "Arus PLN (A)",
      data: [
        5, 4.5, 5, 5.5, 4.8, 5.2, 5, 4.7, 4.9, 5, 5.2, 4.8, 
        5.1, 5.3, 4.9, 5.2, 5, 4.8, 5.1, 5.3, 5, 4.7, 4.5, 4.8
      ],
      borderColor: "blue",
      borderWidth: 2,
      yAxisID: 'y2',
  ...
  datasets: [
    {
      ...
      data: [
        12.5, 12.3, 12.1, 12.0, 11.8, 11.6, 11.4, 11.3, 11.5, 
        11.8, 12.0, 12.2, 12.4, 12.6, 12.8, 12.7, 12.5, 12.3, 
        12.1, 11.9, 11.8, 11.6, 11.4, 11.2
      ],
  ...
  datasets: [
    {
      ...
      data: [
        12.0, 12.0, 12.0, 12.0, 12.0, 11.9, 11.7, 11.5, 11.4, 
        11.3, 11.2, 11.0, 10.8, 10.7, 10.6, 10.5, 10.4, 10.3, 
        10.2, 10.1, 10.0, 9.9, 9.8, 9.7
      ],
      borderColor: "red",
      borderWidth: 2,
      yAxisID: 'y1',
  ...
  options: {
    ...
    scales: {
      ...
      y2: {
        ...
        grid: {
          drawOnChartArea: false, // Jangan tampilkan garis grid untuk sumbu ini
        },
      },
    },
    plugins: {
      zoom: {
        pan: {
          enabled: true,
          mode: 'x', // Mengaktifkan panning hanya pada sumbu x untuk label waktu
        },
        zoom: {
          wheel: {
            enabled: true, // Zoom menggunakan scroll wheel
          },
          pinch: {
            enabled: true // Zoom menggunakan pinch (untuk perangkat layar sentuh)
          },
          mode: 'x', // Zoom hanya pada sumbu x (label waktu)
        },
      },
      title: {
        display: true,
      ...
      tooltip: {
        callbacks: {
          label: function (context) {
            ...
            return `${label}: ${value}${context.dataset.yAxisID === 'y1' ? 'V' : 'A'} at ${time}`;
          },
        },
      },
    },
